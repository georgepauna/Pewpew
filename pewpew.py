...
class BitmapFont7x9(BitmapFont):
    """7x9 base glyph variant of BitmapFont. At scale 1 the line height
    is 9 px — slotted between FONT_5x7 scale 1 (7 px) and scale 2 (14
    px) for editor rows that need more breathing room without growing
    to double size. Same render API and unicode fallback table."""
    BASE_W = 7
    BASE_H = 9
