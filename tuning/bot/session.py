    ...
    def run(self):
        ...
        for step in range(self.max_steps):
            ...
            self.telemetry["events"].append({
                ...
                "main_rail_lvl":   save.loadout.main_rail,
                "main_ball_lvl":   save.loadout.main_ball,
                "main_vulcan_lvl": save.loadout.main_vulcan,
                "main_lvl": max(save.loadout.main_rail,
                                 save.loadout.main_ball,
        ...
        self.telemetry["summary"] = {
            ...
            "final_main_rail_lvl":   save.loadout.main_rail,
            "final_main_ball_lvl":   save.loadout.main_ball,
            "final_main_vulcan_lvl": save.loadout.main_vulcan,
            "final_main_lvl": max(save.loadout.main_rail,
                                   save.loadout.main_ball,
                                   save.loadout.main_vulcan),
